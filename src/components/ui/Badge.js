...
const VARIANTS = {
  ...
  VERIFIED:         'bg-stone-100 text-stone-600',
  // PO status
  DRAFT:            'bg-stone-50  text-stone-400',
  ...
  // Task / PO urgency / priority
  LOW:      'bg-stone-50  text-stone-400',
  MEDIUM:   'bg-blue-50   text-blue-600',
  HIGH:     'bg-amber-50  text-amber-700',
  CRITICAL: 'bg-red-50    text-red-600',
  NORMAL:   'bg-stone-50  text-stone-400',
...
// Human-readable labels for multi-word enums
const LABELS = {
